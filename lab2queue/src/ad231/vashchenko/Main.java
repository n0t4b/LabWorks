...
public class Main {
    public static void main(String[] args) {
        ...
        Item removedItem = cart.removeItem(); // Зберігаємо видалений товар у змінній
        if (removedItem != null) { // Перевіряємо, чи товар був видалений
            System.out.println("Видалений товар: " + removedItem.getName());
        }
